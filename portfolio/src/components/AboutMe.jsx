...
const AboutMe = () => {
  return (
    <section className="flex flex-col items-center w-full h-[100vh] p-5">
      ...
      <div className="flex flex-col items-start w-[70%] h-[220px] mt-14 pb-4 border-b-2 border-b-[#eee]">
        <img id="About_me" src={About_Me} alt="About me" className="relative z-0 h-[50%] w-[25%] drop-shadow-xl mx-auto" />        
      ...
      <div id="about_text" className="flex flex-col items-start w-[70%] mt-6 p-4 text-justify text-[#444] text-lg ">
        <div className="flex">
          <p className='text-md'>Soy 
          <a href="#cv" className="mx-1 font-semibold italic"> Desarrollador Web Fullstack </a>  
