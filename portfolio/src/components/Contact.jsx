...
const Contact = () => {
  return (
    <section className="flex flex-col items-center w-full h-[650px] md:h-[100vh]">
      <div className='flex flex-col items-center md:w-[70%] h-full '>
        ...
        <div className='flex flex-col items-center h-full w-full'>
          ...
          <form id="Contact" action="https://formsubmit.co/e848edbccb8aa7e9c2efdc3160874b26" method="POST" className='flex flex-col w-full md:w-[50%] h-[280px] mt-8 md:mt-4'>
          ...
          <hr className="w-[80%] md:w-[30%] h-[1px] mb-5 bg-[#ccc]" />
          <p className='mb-3 w-full text-center'>Tambien puedes contactarme por alguna de mis redes</p>
