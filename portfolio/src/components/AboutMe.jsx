...
const AboutMe = () => {
  return (
    <section id="About_me" className="flex flex-col items-center w-full h-fit p-5">
      ...
      <div className="flex flex-col items-start w-[90%] md:w-[70%] md:h-[220px] mt-14 md:pb-4">
      ...
      <div className="flex flex-col items-start w-full md:w-[70%] md:mt-6 p-4 text-justify text-[#444] text-lg">
        <div className="flex">
